          ...
          <div className="mb-6 flex items-center justify-between">
            <div>
              ...
              <p className="text-foreground/70 text-base max-w-2xl">
                Find your dream property to buy. Browse through our curated selection of available properties for sale.
              </p>
            </div>
                        ...
                        <CardContent className="p-4">
                          ...
                          <div className="flex items-center justify-between">
                            <div>
                              ...
                              <p className="text-xs text-foreground/60">for sale</p>
                            </div>
